          ...
          <>
           {searchProducts.length == 0 ? 
            ...
            searchProducts.map((res,index)=>{
                return(
                <div onClick={()=>{navigateToSearch('/pr/' + res.route)}} key={index} className='py-[5px] flex items-center border-b-[1px] border-b-slate-100 last:border-b-[0px] justify-between'>
                    ...
                    <h6 className='text-[12px] line-clamp-2'>{res.item}</h6> 
                    </div>
