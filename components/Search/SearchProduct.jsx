            ...
            <>
              {searchProducts.length == 0 ?
                ...
                searchProducts.map((res, index) => {
                  return (
                    <div onClick={() => { navigateToSearch('/pr/' + res?.document?.item_code) }} key={index} className='py-[5px] flex items-center border-b-[1px] cursor-pointer border-b-slate-100 last:border-b-[0px] justify-between hover:bg-[#f1f1f1]'>
